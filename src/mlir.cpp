...
void reg_phases(Flags2Phases& phases) { Phase::hook<plug::mlir::emit, mlir_be::Emit>(phases); }
extern "C" MIM_EXPORT Plugin mim_get_plugin() { return {"mlir", MIM_VERSION, nullptr, reg_phases}; }
